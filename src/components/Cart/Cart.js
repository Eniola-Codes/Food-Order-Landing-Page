      ...
      <div className={classes.items}>
        ...
        <div className={classes.item}>
          ...
          <div className={classes.item_img_div}>
            <img className={classes.item_image} src={dish1} alt='food'></img>
          </div>
          ...
          <div className={classes.item_buttons}>
                ...
                <div><i className="bi bi-plus"></i></div>
            </div>   
        </div>
        ...
        <div className={classes.item}>
          <div className={classes.item_content}>
          <div className={classes.item_img_div}>
            <img className={classes.item_image} src={dish3} alt='food'></img>
          </div>
          <div className={classes.item_value}>
            <div className={classes.item_name_div}>
              <p>Porridge beans</p>
        ...
        <div className={classes.item}>
          <div className={classes.item_content}>
          <div className={classes.item_img_div}>
            <img className={classes.item_image} src={dish5} alt='food'></img>
          </div>
          <div className={classes.item_value}>
            <div className={classes.item_name_div}>
              <p>Amala and ewedu</p>
        ...
        <div className={classes.buttons}>
          ...
          <TheButton className={classes.btn_style2}>
            Order
          </TheButton>
        </div>
      </div>
