...
const HeroThreeSection = () => {
  return (
    <section>
      <Container>
        <Row className={`${classes.row} mx-auto`}bdata-aos="fade-up" data-aos-easing="ease-out"
      data-aos-duration="700">
        ...
        <Row className={classes.row_dish}>
          <Col lg={4} className={classes.dish_col} data-aos="fade-up" data-aos-easing="ease-out"
     data-aos-duration="700">
          ...
          <Col lg={4} className={`${classes.dish_col} ${classes.dish_col_mid}`} data-aos="fade-up" data-aos-easing="ease-out"
     data-aos-duration="700">
            <div className={classes.dish_content}>
              <div className={classes.dish_image_div}>
